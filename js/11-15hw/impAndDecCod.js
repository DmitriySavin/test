...
//    
  ...
  const getUsersWithEyeColor = (users, color) => {
    const blueEyes = users.filter((obj) => obj.eyeColor === color);
...
const getInactiveUsers = users => {
    const usersIsActive = users.filter(obj => obj.isActive === false);
...
const userEmail = users.find(obj => obj.email === email);
